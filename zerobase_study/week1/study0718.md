...
![img_6.png](img_6.png)
[서킷 브레이커에서 서킷의 상태 변화(원본 출처: Circuit Breaker pattern)]
...
- MEERCAT이 자동으로 외부 시스템과 연결을 끊을 때의 트래픽
![img_14.png](img_14.png)
[MEERCAT이 방어 동작을 실행할 때의 트래픽 상황]
